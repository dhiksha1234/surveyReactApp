...
function WelcomePage(){
    return(
        <>
          ...
          <Row mt='4'>
            <div className='display-3 text-center fw-bold mt-4 welcomeTitle'>
            Welcome to your Personal Learning Profile
            </div>
             
            <Col className='mt-4 mx-4 welcomeText'>
            Welcome All
            <br/>
            ...
            <div>
            <Link to="/form"><button type="button" className = "btn btn-warning btn-sm btn-rounded mt-5 mx-5 startedBtn"> Get Started </button></Link>
            </div>
